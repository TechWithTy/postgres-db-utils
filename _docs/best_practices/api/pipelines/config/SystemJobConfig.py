...
class SystemJobConfig(JobConfig):
    ...
    endpoint_configs: dict[str, EndpointConfig] = Field(default_factory=lambda: {
        "system_health": EndpointConfig(
            auth=SecurityConfig(
                permission_roles_required=[RoleTypeEnum.system, RoleTypeEnum.admin],
                user_permissions_required=[PermissionEnum.read_system],
                mfa_required=False,
            ),
            ...
            security=SecurityConfig(permission_roles_required=[RoleTypeEnum.system]),
        ...
        "system_restart": EndpointConfig(
            auth=SecurityConfig(
                ...
                user_permissions_required=[PermissionEnum.restart_system],
                mfa_required=True,
            ),
